...
class Util 
{
    public function getRestPkiClient()
    {
        $accessToken = Settings::set()['restPki']['accessToken'];
        ...
        | -----------------------------------------------------------------------------------------------------------
        */
        $endpoint = Settings::set()['restPki']['endpoint'];
        if (empty($endpoint)) {
    ...
    */
    ...
    public function setExpiredPage()
    {
    ...
    public function formatVerificationCode($code)
    {
        /*
        * Examples
        * --------
    ...
    public function parseVerificationCode($code)
    {
        $text = '';
        for ($ind = 0; $ind < strlen($code); $ind++) {
            if ($code[$ind] != '-') {
