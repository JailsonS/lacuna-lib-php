...
class UtilPades 
{
    public function getVisualRepresentation($client)
    {
        ...
        $visualRepresentation = [
            ...
            'image' => [
                ...
                'resource' => [
                    'content' => base64_encode(file_get_contents(__DIR__.'/../content/PdfStamp.png')),
                    'mimeType' => 'image/png'
                ],
     ...
     * @return PdfMark|null
     */
    public function getPdfMark($sampleNumber)
    {
